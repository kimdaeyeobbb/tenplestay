...
const Modal: React.FC<ModalProps> = ({
  ...
  /* 안내 받을 수단 선택 */
  const checkedRadioPath = '/src/assets/images/button/radio_checked.png';
  const uncheckedRadioPath = '/src/assets/images/button/radio_unchecked.png';
          ...
          <section className="border-b border-gray-400 flex pt-10 pb-6 justify-between items-center text-white">
            ...
            <div className=" justify-center items-center flex">
              <button className="close" onClick={closeModal}>
                <img src="/src/assets/images/icon/x.png" alt="Placeholder" />
              </button>
            </div>
          </section>
          {/* 사이트 URL 및 키워드 입력  */}
